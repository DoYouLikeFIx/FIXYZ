# Story 6.5: [FEP] Manual Replay/Recovery API
...
1. Given authorized operator request When replay endpoint called Then operation is accepted with replay tracking id.
2. Given unauthorized caller When replay is attempted Then forbidden response and security event are produced.
3. Given duplicate replay request When same replay identity used Then idempotent replay behavior is enforced.
4. Given replay completion/failure When operation ends Then final result is auditable.
...
- /Users/yeongjae/fixyz/_bmad-output/implementation-artifacts/6-5-manual-replay-recovery-api.md
